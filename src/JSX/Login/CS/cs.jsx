...
//     // Validasi sebelum mengirim (tambahan dari perbaikan sebelumnya)
//     if (editId === null) {
...
//     try {
//       // Jika ada file foto_ktp_penitip, gunakan FormData
...
//         : err.message;
//       alert(`Gagal menambahkan/memperbarui data penitip: ${errorMessage}. Detail: ${errorDetails}`);
//     }
//   };
